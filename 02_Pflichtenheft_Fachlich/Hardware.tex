...
Der Kontrollprint vergleicht diese Messwerte mit den Sollwerten einer funktionierenden Solarzelle und entscheidet dann ob dieses noch funtkionsfähig ist. Falls dem nicht so ist, wird eine Relaiskontakt geschlossen und es wird auf einem Display angezeigt welches Panel defekt ist. 
...
Der AD Wandler soll mindestens 10 Bit Auflösung haben und die Werte seriell ausgeben können. Dieser empfängt die skalierten Spannungswerte und digitalisiert diese für den Microkontroller.
...
Da mehrere Bauteile noch nicht definiert sind, kann die genaue DC Spannung noch nicht bestimmt werden. Die Speisung speist den Microkontroller, den Powerline transceiver und die Anzeigeelemente.
...
Wenn die Sollspannung eines Panels nicht erreicht wird, steuert der Microcontroller einen Relaiskontakt an, an welchem externe Geräte galvanisch getrennt angeschlossen werden können.
